...
VALUES
  (1, 11, '2025-04-05 14:00:00', '2025-04-06 10:30:00'),
  (2, 12, '2025-04-06 15:00:00', '2025-04-07 09:45:00'),
  (3, 13, '2025-04-07 16:00:00', NULL),
  (4, 14, '2025-04-08 10:00:00', '2025-04-08 14:20:00'),
  (5, 15, '2025-04-09 12:30:00', NULL),
  (6, 16, '2025-04-10 09:00:00', '2025-04-10 17:00:00'),
  (7, 17, '2025-04-11 11:15:00', '2025-04-12 08:50:00'),
  (8, 18, '2025-04-12 13:45:00', NULL),
  (9, 19, '2025-04-13 14:30:00', '2025-04-13 18:00:00'),
  (10, 20, '2025-04-14 10:00:00', NULL);

INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (11, '0000000000000001');

INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (11, '0000000000000004');

INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (11, '0000000000000005');

INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (13, '0000000000000005');
...
INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (12, '0000000000000007');

INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (12, '0000000000000007');

INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (14, '0000000000000009');
INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (14, '0000000000000007');

INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (14, '0000000000000004');

INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (14, '0000000000000004');

INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (14, '0000000000000004');

INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (15, '0000000000000001');

INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (15, '0000000000000001');

INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (15, '0000000000000002');

INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (16, '0000000000000011');

INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (15, '0000000000000011');

INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (16, '0000000000000012');


INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (16, '0000000000000007');


INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (16, '0000000000000003');


INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (17, '0000000000000010');
...
INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (18, '0000000000000009');

INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (19, '0000000000000002');

INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (19, '0000000000000004');

INSERT INTO ORDER_INCLUDES (order_id, UPC) VALUES (20, '0000000000000007');
