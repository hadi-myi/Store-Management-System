...
CREATE TABLE ORDER (
  ...
  FOREIGN KEY (store_id) REFRENCES STORE(store_id) ON DELETE CASCADE 
...
CREATE TABLE REORDER_REQUEST(
  ...
  FOREIGN KEY (vendor_id) REFRENCES VENDOR(vendor_id) ON DELETE CASCADE
  FOREIGN KEY (UPC) REFRENCES PRODUCT(UPC) ON DELETE CASCADE
  FOREIGN KEY (store_id) REFRENCES STORE(store_id) ON DELETE CASCADE
);
...
CREATE TABLE PACKAGE_TYPE (
    UPC CHAR(16) PRIMARY KEY NOT NULL,
